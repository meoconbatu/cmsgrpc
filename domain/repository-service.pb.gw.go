...
func request_PageService_GetAll_0(ctx context.Context, marshaler runtime.Marshaler, client PageServiceClient, req *http.Request, pathParams map[string]string) (PageService_GetAllClient, runtime.ServerMetadata, error) {
...
func RegisterPageServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PageServiceServer) error {
	...
	mux.Handle("POST", pattern_PageService_GetAll_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterPageServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PageServiceClient) error {
	...
	mux.Handle("POST", pattern_PageService_GetAll_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_PageService_GetAll_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_PageService_GetAll_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_PageService_GetAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"page"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_PageService_GetAll_0 = runtime.ForwardResponseStream
)
